...
use Vuetube\Channel;
use Vuetube\Http\Requests\Channels\UpdateChannelRequest;
use Validator;

class ChannelController extends Controller
{
    public function __construct() {
        $this->middleware(['auth'])->only('update'); // Verificar que el usuario esta logeado para hacer la funcion update
    }
    /**
